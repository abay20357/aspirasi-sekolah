...
@section('content')
    <div class="max-w-2xl mx-auto">
        <div class="mb-6 animate-fade-in-up">
            ...
            <h1 class="text-2xl font-bold text-slate-800">Edit Kategori Lokasi</h1>
            <p class="text-slate-500 mt-1">Perbarui informasi lokasi.</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden animate-fade-in-up delay-100"
            ...
            <div class="p-6 md:p-8">
                <form action="{{ route('admin.categories.update', $category->id) }}" method="POST"
                    enctype="multipart/form-data" class="space-y-5" @submit="isSubmitting = true">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="3"
                            ...
                            placeholder="Jelaskan lokasi ini...">{{ old('description', $category->description) }}</textarea>
                        @error('description')
                            <p class="mt-1.5 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <!-- Image Upload -->
                    <div>
                        <label class="block text-sm font-semibold text-slate-700 mb-1.5">Foto Lokasi</label>
                    ...
                    <div class="pt-4 border-t border-slate-100 flex justify-end gap-3">
                        ...
                        <button type="submit"
                            ...
                            <span x-text="isSubmitting ? 'Menyimpan...' : 'Update'"></span>
                        </button>
                    </div>
                </form>
            </div>
